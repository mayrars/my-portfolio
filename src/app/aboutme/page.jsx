...
export default function AboutPage() {
    return (
        <Container className="pt-4">
            <h1>About me</h1>
            <p>
                Desarrolladora web con más de 5 años de experiencia. Deseosa de
                crecer en el campo del desarrollo; aprender nuevas tecnologías y
                buenas practicas.
            </p>
            <section>
                <Container>
                    <Row>
                        <Col lg={6} md={6} sm={12} xs={12}>
                            ...
                            <ul>
                                ...
                                <li>
                                    Administración, diseño, modelado y soporte
                                    de bases de datos
                                </li>
                        ...
                        <Col lg={6} md={6} sm={12} xs={12}>
                            ...
                            <ul>
                                ...
                                <li>Organizada</li>
                                <li>
                                    Capacidad de trabajar tanto individualmente
                                    como en equipo
                                </li>
                                <li>Comprometida</li>
                                <li>Analítica</li>
